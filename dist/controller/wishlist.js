...
const artworkBids = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.status(200).json({ msg: "All bids for a specific artwork fetched successfully", data: artworkWithBids });
    }
    catch (error) {
        console.error(error);
...
const creatingBids = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (price > ((_b = auction === null || auction === void 0 ? void 0 : auction.dataValues) === null || _b === void 0 ? void 0 : _b.currentPrice)) {
            // Create a new bidder
            const bidder = yield bidModel_1.BidInstance.create(Object.assign({ id: uuid, bidderID: id, artworkID: auctionId, bidTime: new Date() }, req.body));
            if (!bidder) {
