...
exports.artworksOnAuction = exports.artworksOnSale = exports.getOneArt = exports.getAllArtworks = exports.CreateArt = void 0;
...
const CreateArt = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return res.status(200).json({ msg: "Art created successfully" });
    }
    catch (err) {
        console.log(err);
